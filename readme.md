...
This will create an executable jar file **ws-contact-exec.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/ws-contact-exec.jar
